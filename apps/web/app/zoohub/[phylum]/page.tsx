...
export default async function PhylumPage({
  ...
  return (
    <div className="w-full max-w-[90rem] mx-auto py-8 px-4 sm:px-8 lg:px-12 xl:px-16 bg-transparent">
      
      {/* 🚀 Ultra-Minimalist Editorial Hero Section */}
      <div className="mb-32 pt-16 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-24 mt-16 px-4">
              {cls.species.map((species: any, i: number) => (
                ...
                >
                  ...
                  <h3 className="text-2xl font-extrabold italic text-slate-800 dark:text-slate-100 mb-3 group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors duration-300">
                    {species.name}
                  </h3>
                  ...
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/50 mt-auto group-hover:border-emerald-200 group-hover:bg-emerald-50 transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 256 256" className="text-emerald-500">
