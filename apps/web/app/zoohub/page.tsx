...
import { getRandomSpeciesForMarquee } from "@/lib/supabase/zoohub-public";

export const dynamic = "force-dynamic";

export default async function ZoohubPage() {
  const allSpecies = await getRandomSpeciesForMarquee(20);
  ...
  return (
    <div className="w-full max-w-[90rem] mx-auto py-[clamp(2rem,5vw,4rem)] px-[clamp(1rem,4vw,4rem)] overflow-hidden">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .animate-marquee-3d { animation: marquee-3d 40s linear infinite; }
        .animate-marquee-3d-reverse { animation: marquee-3d-reverse 40s linear infinite; }
      `}} />
    </div>
  );
}
